...
const (
	...
	MovieService_GetMovie_FullMethodName    = "/moviepb.MovieService/GetMovie"
	MovieService_UpdateMovie_FullMethodName = "/moviepb.MovieService/UpdateMovie"
	MovieService_DeleteMovie_FullMethodName = "/moviepb.MovieService/DeleteMovie"
	MovieService_ListByGenre_FullMethodName = "/moviepb.MovieService/ListByGenre"
	MovieService_ListByActor_FullMethodName = "/moviepb.MovieService/ListByActor"
)
...
type MovieServiceClient interface {
	...
	ListByGenre(ctx context.Context, in *ListByGenreRequest, opts ...grpc.CallOption) (*ListByGenreResponse, error)
	ListByActor(ctx context.Context, in *ListByActorRequest, opts ...grpc.CallOption) (*ListByActorResponse, error)
}
...
func (c *movieServiceClient) ListByGenre(ctx context.Context, in *ListByGenreRequest, opts ...grpc.CallOption) (*ListByGenreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListByGenreResponse)
	err := c.cc.Invoke(ctx, MovieService_ListByGenre_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) ListByActor(ctx context.Context, in *ListByActorRequest, opts ...grpc.CallOption) (*ListByActorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListByActorResponse)
	err := c.cc.Invoke(ctx, MovieService_ListByActor_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServiceServer interface {
	...
	ListByGenre(context.Context, *ListByGenreRequest) (*ListByGenreResponse, error)
	ListByActor(context.Context, *ListByActorRequest) (*ListByActorResponse, error)
...
func (UnimplementedMovieServiceServer) ListByGenre(context.Context, *ListByGenreRequest) (*ListByGenreResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListByGenre not implemented")
}
func (UnimplementedMovieServiceServer) ListByActor(context.Context, *ListByActorRequest) (*ListByActorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListByActor not implemented")
}
...
func _MovieService_ListByGenre_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListByGenreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).ListByGenre(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_ListByGenre_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).ListByGenre(ctx, req.(*ListByGenreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _MovieService_ListByActor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListByActorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).ListByActor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_ListByActor_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).ListByActor(ctx, req.(*ListByActorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MovieService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListByGenre",
			Handler:    _MovieService_ListByGenre_Handler,
		},
		{
			MethodName: "ListByActor",
			Handler:    _MovieService_ListByActor_Handler,
		},
	},
